...
(* OASIS_START *)
(* DO NOT EDIT (digest: f9e1b7b14a143820d8c187782cf6c02a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/fold-lang/fold";
          bugreports = None;
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("pure", None);
                           FindlibPackage ("iter", None);
                           FindlibPackage ("ppx_format", None);
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "/\155\001#\003\233\165\"$\025q^f\176/\180";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
